...
import req2test.tool.approach.filter.testcase.unit.controller.ListMockTestCaseGetEndpointFilter

class ListMockTestCaseGetEndpointValidationsFilter (data: MutableMap<String, Any?>): ListMockTestCaseGetEndpointFilter(data){

    override fun filterKeyInput(): String { return "ListGetEndpointMockScript" }
    override fun filterName(): String {

        return "ListMockTestCaseGetEndpointValidationsFilter"
    }
