...
class ListFilterEndpointMockScriptFilter (data: MutableMap<String, Any?>) : ListCreateEndpointMockScriptFilter(data) {
    override fun filterKeyInput(): String {
        return "ListACRules"
    }

    override fun filterName(): String {
        return "ListFilterEndpointMockScriptFilter"
    }

    override fun filterKeyOutput(): String {
        return "ListFilterEndpointMockScript"
    }
