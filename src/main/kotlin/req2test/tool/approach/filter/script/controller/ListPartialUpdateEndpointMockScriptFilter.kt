...
class ListPartialUpdateEndpointMockScriptFilter (data: MutableMap<String, Any?>) : ListCreateEndpointMockScriptFilter(data) {
    override fun filterKeyInput(): String {
        return "ListACRules"
    }

    override fun filterName(): String {
        return "ListPartialUpdateEndpointMockScriptFilter"
    }

    override fun filterKeyOutput(): String {
        return "ListPartialUpdateEndpointMockScript"
    }
