...
class ListGenericEndpointScriptFilter (data: MutableMap<String, Any?>) : ListCreateEndpointScriptFilter(data) {
    override fun filterKeyInput(): String {
        return "ListACRules"
    }

    override fun filterName(): String {
        return "ListGenericEndpointScriptFilter"
    }

    override fun filterKeyOutput(): String {
        return "ListGenericEndpointScript"
    }
    ...
    override fun getInputTechniques(): List<InputTechnique>{
