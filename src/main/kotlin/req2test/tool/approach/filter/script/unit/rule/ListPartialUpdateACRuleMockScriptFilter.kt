...
class ListPartialUpdateACRuleMockScriptFilter (data: MutableMap<String, Any?>) : ListCreateACRuleMockScriptFilter(data) {
    override fun filterKeyInput(): String {
        return "ListACRules"
    }

    override fun filterName(): String {
        return "ListPartialUpdateACRuleMockScriptFilter"
    }

    override fun filterKeyOutput(): String {
        return "ListPartialUpdateACRuleMockScript"
    }
