...
open class ListCreateEndpointScriptFilter (data: MutableMap<String, Any?>) : Filter(data, null) {
    ...
    override fun filterName(): String {
        return "ListCreateEndpointScriptFilter"
    }

    override fun filterKeyOutput(): String {
        return "ListCreateEndpointScript"
    }
    ...
    override fun compute(input: Any): Any? {
        ...
        listACRules.forEach { ACRule ->
            ...
            val objective = "Detect faults when validating the behavior of $location, ensuring it responds correctly to interactions and conditions"
        ...
        TestPlanGenerator.createFile(textScripts, "outputArtifacts/", "IntegrationEndpoint${getRuleAction()}Scripts.txt")
